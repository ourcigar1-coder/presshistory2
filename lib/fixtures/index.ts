...
export const SLICE_CARDS: NodeCard[] = [
  { _id: posterEntry._id, _type: "entry", title: posterEntry.title, slug: "poster", shortDescription: posterEntry.shortDescription, domain: posterEntry.domain, thumbnail: null },
  ...
  { _id: gumArabicStory._id, _type: "story", title: gumArabicStory.question, slug: "why-gum-arabic-likes-water", shortDescription: undefined, domain: gumArabicStory.domain, thumbnail: null },
  ...
  { _id: patterningBridge._id, _type: "bridge", title: patterningBridge.title, slug: "from-printing-to-patterning", shortDescription: patterningBridge.shortDescription, domain: patterningBridge.domain, thumbnail: null },
];
